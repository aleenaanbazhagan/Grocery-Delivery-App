  ...
  return (
    <div className="min-h-screen bg-surface pb-20">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-6 text-left">My Orders</h1>
        ...
        {orders.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2 text-center">No orders yet</h2>
            <p className="text-gray-500 mb-6 text-center">Start shopping to see your orders here</p>
            <Link
              to="/"
